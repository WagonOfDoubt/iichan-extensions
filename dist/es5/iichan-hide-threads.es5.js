...
(function () {
  ...
  */
  ...
  var addPlaceholder = function addPlaceholder(thread) {
    ...
    thread.insertAdjacentHTML('beforebegin', "\n    <div class=\"reply ".concat(PLACEHOLDER_CLASSNAME, "\" id=\"").concat(placeholderId, "\">\u0422\u0440\u0435\u0434 <a>\u2116").concat(threadNo, "</a> \u0441\u043A\u0440\u044B\u0442 (").concat(threadTitle || 'изображение', ")</div>\n  "));
